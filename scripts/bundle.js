...
var _mapForm = require("./mapForm.js");

var _comprehensionForm = require("./comprehensionForm.js");
...
},{"./comprehensionForm.js":1,"./inputValidator":2,"./listFactory":3,"./mapForm.js":5}],5:[function(require,module,exports){
'use strict';
...
function mapSubmit(validate, list) {
    (0, _jquery2.default)('#map-form').submit(function (event) {
        (0, _jquery2.default)('#err').text('');
        event.preventDefault();
        try {
            if (!list.c) {
            ...
            var mapFunction = (0, _jquery2.default)(this).serializeArray();
            ...
            (0, _jquery2.default)('#list').text('>>> my_list = [' + list.c.join(', ') + ']');
        } catch (err) {
            (0, _jquery2.default)('#err').text(err.message);
        }
    });
}

},{"./inputValidator":2,"jquery":6}],6:[function(require,module,exports){
/*!
